function [errorl,time,mu_x,gammare,H_re] = kroSBL_am(noise_var,Res1,numItr,H,H_p1,H_p2,A1,A2,y,K2,irs_pattern,A_irs_a,A_irs_d,H1,H2,SNR,thres,overheadi)
...
gamma1 = ones(Res1,1); % prior on the gamma1
gamma2 = ones(Res1,1); % prior on the gamma2
gamma3 = ones(Res1,1); % prior on the gamma3
...
% re-estimate
[mu_x,~] = posterior_compute2(noise_var,gamma1,gamma2,gamma3,H_p1,H_p2,A2,H,y);
